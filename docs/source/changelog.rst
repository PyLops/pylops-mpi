...
* Added :func:`pylops_mpi.optimization.sparsity.ista`, an iterative shrinkage-thresholding algorithm.
* Added :func:`pylops_mpi.optimization.sparsity.fista`, a fast variant of ISTA.
